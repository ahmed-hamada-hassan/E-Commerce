...
internal sealed class SpecificRegisterCommandValidator : AbstractValidator<SpecificRegisterCommand>
{
    public SpecificRegisterCommandValidator()
    {
        ...
        RuleFor(U => U.PhoneNumber)
            ...
            .Matches(@"^\+?[0-9]\d{1,14}$").WithMessage("Invalid phone number format eg(01234567890).");
